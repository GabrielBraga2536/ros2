...
class MyNode(Node):
  ...
  def __init__(self):
    ...
    self.subscriber_1 = Subscriber(self, String, "topico1")
    self.subscriber_2 = Subscriber(self, String, "topico2")

    self.sync = ApproximateTimeSynchronizer([self.subscriber_1, self.subscriber_2], 10, slop=0.2, allow_headerless=True)
